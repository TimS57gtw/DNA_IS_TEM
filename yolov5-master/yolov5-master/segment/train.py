...
def parse_opt(known=False):
    ...
    ds = r'D:\seifert\PycharmProjects\LiuDimer\yolov5-master\yolov5-master\data\SetV5IS_400_PP.yaml'
    parser = argparse.ArgumentParser()
    parser.add_argument("--weights", type=str, default=ROOT / "yolov5m-seg.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default="", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ds, help="dataset.yaml path")
