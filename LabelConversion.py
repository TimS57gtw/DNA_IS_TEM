...
if __name__ == "__main__":
    input_ = r'F:\Data\LiuDimer\RealLabeled\labels'
    output = r'F:\Data\LiuDimer\RealLabeled\YOLO_LBL'
    imgs = r'F:\Data\LiuDimer\RealLabeled\imagesSample'
    os.makedirs(output, exist_ok=True)
    # labelme_json_to_yolo_seg_format(input_, output)
    show_yolo_txt_image(output, imgs)