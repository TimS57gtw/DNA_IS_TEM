...
#
   #  while False:
    ...
    outfld = os.path.join('SynthData', 'Set5_eval', 'images',   'test')
    outlbl = os.path.join('SynthData', 'Set5_eval', 'labels_ss','test')
    isfld =  os.path.join('SynthData', 'Set5_eval', 'labels',   'test')
